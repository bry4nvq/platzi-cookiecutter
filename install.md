# platzi_cookie guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `platzi_cookie/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `platzi_cookie` folder and use the modules inside your notebooks :
...
```python
from platzi_cookie.utils.paths import data_dir
data_dir()
```
